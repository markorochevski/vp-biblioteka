...
namespace vp_proektna_biblioteka.BooksDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Id], [Title], [Author], [Category]) VALUES (@Id, @Tit" +
                "le, @Author, @Category);\r\nSELECT Id, Title, Author, Category FROM Books WHERE (I" +
                "d = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Id] = @Id, [Title] = @Title, [Author] = @Author, [Category] = @Category WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)));
SELECT Id, Title, Author, Category FROM Books WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::vp_proektna_biblioteka.Properties.Settings.Default.BooksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Title, Author, Category FROM dbo.Books";
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_Author, string Original_Category) {
        ...
        public virtual int Insert(int Id, string Title, string Author, string Category) {
        ...
        public virtual int Update(int Id, string Title, string Author, string Category, int Original_Id, string Original_Title, string Original_Author, string Original_Category) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string Category, int Original_Id, string Original_Title, string Original_Author, string Original_Category) {
            return this.Update(Original_Id, Title, Author, Category, Original_Id, Original_Title, Original_Author, Original_Category);
        }
    }
